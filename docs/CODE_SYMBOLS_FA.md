...
**Python files scanned: 389 | Dashboard JS files scanned: 5 | Symbols indexed: 3448**
...
| `apps/api/runbook_execution.py` | `dry_run` | 355 | async function | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | module |
