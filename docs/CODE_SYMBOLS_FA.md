...
| `tests/integration/test_dashboard_api.py` | `test_dashboard_ui_contains_live_api_calls` | 9 | function | Regression/contract مورد نام‌برده را در pytest اثبات می‌کند | module |
| `tests/integration/test_dashboard_api.py` | `test_dashboard_route_and_api_are_registered` | 23 | function | Regression/contract مورد نام‌برده را در pytest اثبات می‌کند | module |
| `tests/integration/test_dashboard_api.py` | `test_dashboard_html_css_and_js_are_actually_served_over_http` | 34 | function | Regression/contract مورد نام‌برده را در pytest اثبات می‌کند | module |
| `tests/integration/test_dashboard_api.py` | `test_legacy_dashboard_asset_aliases_remain_available_for_stale_tabs` | 57 | async function | Regression/contract مورد نام‌برده را در pytest اثبات می‌کند | module |
