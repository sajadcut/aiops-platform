...
| `apps/memory_service/__init__.py` | `OperationalMemoryService` | 29 | class | کلاس | module |
| `apps/memory_service/__init__.py` | `OperationalMemoryService.__init__` | 34 | method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | OperationalMemoryService |
| `apps/memory_service/__init__.py` | `OperationalMemoryService.add_entry` | 37 | async method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | OperationalMemoryService |
| `apps/memory_service/__init__.py` | `OperationalMemoryService.add_episode` | 92 | async method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | OperationalMemoryService |
| `apps/memory_service/__init__.py` | `OperationalMemoryService._embed_entry` | 225 | async method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | OperationalMemoryService |
| `apps/memory_service/__init__.py` | `OperationalMemoryService.retrieve` | 280 | async method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | OperationalMemoryService |
| `apps/memory_service/__init__.py` | `OperationalMemoryService.search_similar` | 366 | async method | داده را بدون تغییر state بازیابی/فهرست می‌کند | OperationalMemoryService |
| `apps/memory_service/__init__.py` | `OperationalMemoryService.record_feedback` | 382 | async method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | OperationalMemoryService |
| `apps/memory_service/__init__.py` | `OperationalMemoryService.backfill_embeddings` | 398 | async method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | OperationalMemoryService |
| `apps/memory_service/__init__.py` | `OperationalMemoryService.mark_stale_entries` | 432 | async method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | OperationalMemoryService |
| `apps/memory_service/__init__.py` | `OperationalMemoryService.invalidate` | 464 | async method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | OperationalMemoryService |
| `apps/memory_service/__init__.py` | `OperationalMemoryService.mark_validated` | 488 | async method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | OperationalMemoryService |
| `apps/memory_service/__init__.py` | `OperationalMemoryService.update_reuse_count` | 499 | async method | state یا داده را به‌صورت durable ذخیره/به‌روزرسانی می‌کند | OperationalMemoryService |
| `apps/memory_service/__init__.py` | `OperationalMemoryService.serialize_entry` | 507 | method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | OperationalMemoryService |
| `apps/memory_service/__init__.py` | `OperationalMemoryService._legacy_embedding_document` | 567 | method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | OperationalMemoryService |
| `apps/memory_service/__init__.py` | `OperationalMemoryService._uuid_or_none` | 583 | method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | OperationalMemoryService |
...
| `apps/memory_service/builder.py` | `OperationalMemoryBuilder.build_embedding_document` | 215 | method | یک ساختار canonical می‌سازد یا ورودی را normalize/resolve می‌کند | OperationalMemoryBuilder |
| `apps/memory_service/builder.py` | `OperationalMemoryBuilder._root_cause` | 255 | method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | OperationalMemoryBuilder |
| `apps/memory_service/builder.py` | `OperationalMemoryBuilder._numeric_map` | 295 | method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | OperationalMemoryBuilder |
| `apps/memory_service/builder.py` | `OperationalMemoryBuilder._normalized_symptoms` | 307 | method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | OperationalMemoryBuilder |
| `apps/memory_service/builder.py` | `OperationalMemoryBuilder._verification` | 317 | method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | OperationalMemoryBuilder |
| `apps/memory_service/builder.py` | `OperationalMemoryBuilder._actual_remediation` | 359 | method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | OperationalMemoryBuilder |
| `apps/memory_service/builder.py` | `OperationalMemoryBuilder._error_class` | 398 | method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | OperationalMemoryBuilder |
| `apps/memory_service/builder.py` | `OperationalMemoryBuilder._outcome_class` | 403 | method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | OperationalMemoryBuilder |
| `apps/memory_service/builder.py` | `OperationalMemoryBuilder._hypotheses` | 426 | method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | OperationalMemoryBuilder |
| `apps/memory_service/builder.py` | `OperationalMemoryBuilder._causal_factors` | 440 | method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | OperationalMemoryBuilder |
| `apps/memory_service/builder.py` | `OperationalMemoryBuilder._contributing_factors` | 449 | method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | OperationalMemoryBuilder |
| `apps/memory_service/builder.py` | `OperationalMemoryBuilder._evidence_items` | 458 | method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | OperationalMemoryBuilder |
...
| `tests/unit/test_operational_memory_v2.py` | `test_episode_fingerprint_is_not_changed_by_secret_value_rotation` | 159 | function | Regression/contract مورد نام‌برده را در pytest اثبات می‌کند | module |
| `tests/unit/test_operational_memory_v2.py` | `test_builder_does_not_convert_recovery_into_confirmed_cause` | 169 | function | Regression/contract مورد نام‌برده را در pytest اثبات می‌کند | module |
| `tests/unit/test_operational_memory_v2.py` | `_FakeScalars` | 179 | class | کلاس | module |
| `tests/unit/test_operational_memory_v2.py` | `_FakeScalars.__init__` | 180 | method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | _FakeScalars |
| `tests/unit/test_operational_memory_v2.py` | `_FakeScalars.first` | 183 | method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | _FakeScalars |
| `tests/unit/test_operational_memory_v2.py` | `_FakeExecuteResult` | 187 | class | کلاس | module |
| `tests/unit/test_operational_memory_v2.py` | `_FakeExecuteResult.__init__` | 188 | method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | _FakeExecuteResult |
| `tests/unit/test_operational_memory_v2.py` | `_FakeExecuteResult.scalars` | 191 | method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | _FakeExecuteResult |
| `tests/unit/test_operational_memory_v2.py` | `_FakeDB` | 195 | class | کلاس | module |
| `tests/unit/test_operational_memory_v2.py` | `_FakeDB.__init__` | 196 | method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | _FakeDB |
| `tests/unit/test_operational_memory_v2.py` | `_FakeDB.add` | 201 | method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | _FakeDB |
| `tests/unit/test_operational_memory_v2.py` | `_FakeDB.execute` | 204 | async method | مسیر اجرای عملیات را از boundary مربوطه عبور می‌دهد | _FakeDB |
| `tests/unit/test_operational_memory_v2.py` | `_FakeDB.commit` | 207 | async method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | _FakeDB |
| `tests/unit/test_operational_memory_v2.py` | `_FakeDB.rollback` | 210 | async method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | _FakeDB |
| `tests/unit/test_operational_memory_v2.py` | `_FakeDB.refresh` | 213 | async method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | _FakeDB |
| `tests/unit/test_operational_memory_v2.py` | `_FakeDB.get` | 216 | async method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | _FakeDB |
| `tests/unit/test_operational_memory_v2.py` | `test_embedding_failure_keeps_core_episode` | 224 | async function | Regression/contract مورد نام‌برده را در pytest اثبات می‌کند | module |
| `tests/unit/test_operational_memory_v2.py` | `test_embedding_failure_keeps_core_episode.fail_embedding` | 225 | async method | تابع/متد با مسئولیت مشخص‌شده توسط نام و فایل میزبان | test_embedding_failure_keeps_core_episode |
