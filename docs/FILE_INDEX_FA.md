...
**تعداد فایل‌های track‌شده و پوشش‌داده‌شده: 311**
...
| `deployment/kubernetes/network-policy.yaml` | K8s | Manifest/نمونه config استقرار | Kubernetes/OpenShift | image/.env/secrets | Deploy | runtime deployment |
