...
**تعداد فایل‌های track‌شده و پوشش‌داده‌شده: 487**
...
| `tests/unit/test_dependency_contract.py` | Test | تست regression/contract برای بخش متناظر | pytest/CI | کد production | Test | شواهد repository-level |
