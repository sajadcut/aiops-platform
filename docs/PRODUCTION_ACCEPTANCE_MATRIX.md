...
1. Real Cognia Application Client authentication over the target environment's approved HTTP or HTTP/HTTPS endpoint; when HTTPS is selected, certificate verification is intentionally disabled.
