...
class InfrastructureAgent(BaseAgent):
    ...
    async def analyze(self, input_data: AgentInput) -> AgentOutput:
        ...
        prompt = f"""You are a senior infrastructure/SRE analyst and reliability investigator. LIVE EVIDENCE is authoritative. Knowledge RAG and Operational Memory are auxiliary only and cannot prove current host state. Do not infer saturation, capacity exhaustion, node failure or network faults without live evidence.
