...
class ApplicationAgent(BaseAgent):
    ...
    async def analyze(self, input_data: AgentInput) -> AgentOutput:
        ...
        compact = evidence[: settings.AGENT_MAX_EVIDENCE_ITEMS]
        prompt = f"""You are a senior SRE application analyst. Use ONLY supplied evidence. Never invent deployments, dependencies, versions, errors or actions already executed.
